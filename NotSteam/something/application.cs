...
#pragma warning restore 414
        ...
        public static InputLanguage CurrentInputLanguage
        {
            ...
            set
            {
                Debug.WriteLineIf(security.IntSecurity.SecurityDemand.TraceVerbose, "AffectThreadBehavior Demanded");
                security.IntSecurity.AffectThreadBehavior.Demand();
        ...
        public static string ExecutablePath
        {
            ...
            get
            {
                ...
                {
                    Debug.WriteLineIf(security.IntSecurity.SecurityDemand.TraceVerbose, "FileIO(" + executablePath + ") Demanded");
        ...
        public static string SafeTopLevelCaptionFormat
        {
            ...
            set
            {
                Debug.WriteLineIf(security.IntSecurity.SecurityDemand.TraceVerbose, "WindowAdornmentModification Demanded");
                security.IntSecurity.WindowAdornmentModification.Demand();
        ...
        public static string StartupPath
        {
            get
            {
                ...
                Debug.WriteLineIf(security.IntSecurity.SecurityDemand.TraceVerbose, "FileIO(" + startupPath + ") Demanded");
        ...
        {
            Debug.WriteLineIf(security.IntSecurity.SecurityDemand.TraceVerbose, "ManipulateWndProcAndHandles Demanded");
        ...
        {
            security.IntSecurity.AffectMachineState.Demand();
            ...
            internal ParkingWindow GetParkingWindow(DpiAwarenessContext context)
            {
                ...
                lock (this)
                {
                    ...
                    if (parkingWindow == null)
                    {
                        ...
                        //           : ever get at it.
                        //
                        security.IntSecurity.ManipulateWndProcAndHandles.Assert();
                        try
                        {
