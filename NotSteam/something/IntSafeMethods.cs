...
#endif
{
    ...
    static partial class IntSafeNativeMethods
    {
        ...
        {
            IntPtr hBrush = HandleCollector.Add(IntCreateSolidBrush(crColor), IntSafeNativeMethods.CommonHandles.GDI);
        ...
        {
            IntPtr hPen = HandleCollector.Add(IntCreatePen(fnStyle, nWidth, crColor), IntSafeNativeMethods.CommonHandles.GDI);
        ...
        {
            IntPtr hPen = HandleCollector.Add(IntExtCreatePen(fnStyle, dwWidth, lplb, dwStyleCount, lpStyle), IntSafeNativeMethods.CommonHandles.GDI);
        ...
        {
            IntPtr hRgn = HandleCollector.Add(IntCreateRectRgn(x1, y1, x2, y2), IntSafeNativeMethods.CommonHandles.GDI);
