...
namespace NotSteam.something
{
    internal class SR
    {
        ...
        internal static string UnknownInputLanguageLayout = "UnknownInputLanguageLayout";
        ...
        internal const string Argument_LogFileNameInvalid = "Argument_LogFileNameInvalid";

        internal const string IO_FileNotFound = "IO_FileNotFound";

        internal const string Unauthorized_AccessDenied = "Unauthorized_AccessDenied";

        internal const string IO_SharingViolation = "IO_SharingViolation";
        
        internal const string IO_EndOfLog = "IO_EndOfLog";

        internal const string IO_InvalidLogFileFormat = "IO_InvalidLogFileFormat";

        internal const string IO_AlreadyExists = "IO_AlreadyExists";

        internal const string IO_DeviceHresult = "IO_DeviceHresult";

        internal const string IO_BlockIncomplete = "IO_BlockIncomplete";

        internal const string Argument_LogInvalidRange = "Argument_LogInvalidRange";

        internal const string IO_LogCannotDelete = "IO_LogCannotDelete";

        internal const string Argument_TailInvalid = "Argument_TailInvalid";

        internal const string DiskFull = "DiskFull";

        internal const string SequenceFull = "SequenceFull";

        internal const string InvalidOperation_LogPolicyInvalid = "InvalidOperation_LogPolicyInvalid";

        internal const string InvalidOperation_LogPolicyConflict = "InvalidOperation_LogPolicyConflict";

        internal const string IO_LogCorrupt = "IO_LogCorrupt";

        internal const string LogRecSeq_IncompatibleVersion = "LogRecSeq_IncompatibleVersion";

        internal const string Argument_NotFound = "Argument_NotFound";

        internal const string Argument_InvalidReservation = "Argument_InvalidReservation";

        internal const string InvalidOperation_MustHaveExtents = "InvalidOperation_MustHaveExtents";

        internal const string IO_UnexpectedException = "IO_UnexpectedException";

        internal const string AsyncResult_DuplicateEnd = "AsyncResult_DuplicateEnd";

        internal const string AsyncResult_Invalid = "AsyncResult_Invalid";

        internal const string LogStore_NotArchivable = "LogStore_NotArchivable";

        internal const string NotSupported_Platform = "NotSupported_Platform";

        internal const string Argument_InvalidSequenceNumber = "Argument_InvalidSequenceNumber";

        internal const string Argument_SequenceNumberNotActive = "Argument_SequenceNumberNotActive";

        internal const string Argument_FileNameInvalid = "Argument_FileNameInvalid";

        internal const string IO_DeviceException = "IO_DeviceException";
